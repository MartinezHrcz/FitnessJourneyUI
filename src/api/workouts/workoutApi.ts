...
export const workoutApi = {
    getAll: () => axiosClient.get<Array<WorkoutDTO>>("/workout"),
    getById: (id: string) => axiosClient.get<WorkoutDTO>(`/workout/${id}`),
    getByUserId: (userId: string) => axiosClient.get<WorkoutDTO>(`/workout/byuser/${userId}`),
    create: (data: WorkoutCreateDTO) => axiosClient.post<string>(`/workout`, data),
    update: (id: string, data: WorkoutUpdateDTO) => axiosClient.put<WorkoutDTO>(`/workout/${id}`, data),
    delete: (id: string) => axiosClient.delete(`/workout/${id}`),
